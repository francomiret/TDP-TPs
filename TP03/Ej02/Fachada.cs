...
namespace Ej02
{
    class Fachada
    {
        ...
        {
            FiguraGeometrica iCirculo = new Circulo(new Punto(0, 0), radio);
            return iCirculo.CalcularArea();
        }
        /// <summary>
        ...
        {
            FiguraGeometrica iCirculo = new Circulo(new Punto(0, 0), radio);
            return iCirculo.CalcularPerimetro();
        }
        /// <summary>
        ...
        public double ObtenerAreaTriangulo(double x1, double y1, double x2, double y2, double x3, double y3)
        {
            ...
            FiguraGeometrica iTriangulo = new Triangulo(p1, p2, p3);
            return iTriangulo.CalcularArea();
        }
        /// <summary>
        ...
        public double ObtenerPerimetroTriangulo(double x1, double y1, double x2, double y2, double x3, double y3)
        {
            Punto p1 = new Punto(x1, y1), p2 = new Punto(x2, y2), p3 = new Punto(x3, y3);
            FiguraGeometrica iTriangulo = new Triangulo(p1, p2, p3);
            return iTriangulo.CalcularPerimetro();
        }
    }
}
